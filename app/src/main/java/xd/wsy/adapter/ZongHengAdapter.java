...
public class ZongHengAdapter extends BaseAdapter {

    private Application mApplication;
    private List<Record> hots;
    private Handler h;

    public ZongHengAdapter(Application a, List<Record> list, Handler h) {
        mApplication = a;
        hots = list;
        this.h = h;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(mApplication, R.layout.activity_zongheng_item, null);
            vHolder.iv = convertView.findViewById(R.id.icon);
            vHolder.name = convertView.findViewById(R.id.name);
        ...
        if (!r.IsShow) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    pic.bytes = app.getzSearchService().getBytes(r.book_picture_src);

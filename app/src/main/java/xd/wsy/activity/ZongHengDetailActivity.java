...
public class ZongHengDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zongheng_detail);
        initWidget();
        String url = getIntent().getStringExtra("bookUrl");
        MyApp app = (MyApp) getApplication();
        final ZongHengSearchService mService = app.getzSearchService();
        if (url != null && !url.equals("")) {
            loading.setVisibility(View.VISIBLE);
            ZongHengBookDetail book = mService.getCache(url);
            if (book != null) {
                ...
                mService.get(url, new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        switch (msg.what) {
                            case 1:
                                ZongHengBookDetail book = (ZongHengBookDetail) msg.obj;
                                if (book != null)
                                    showBookDetail(book, mService);
                                break;
                            case 0:
    ...
    @SuppressLint("HandlerLeak")
    private void showBookDetail(final ZongHengBookDetail book, final ZongHengSearchService mService) {
...
//        Log.i("TAG_book1", bookName);
        ...
        TvWriteComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 * 点击popupWindow让背景变暗
                 */
                final WindowManager.LayoutParams lp = ZongHengDetailActivity.this.getWindow().getAttributes();
                lp.alpha = 0.3f;//代表透明程度，范围为0 - 1.0f
                ZongHengDetailActivity.this.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
                ZongHengDetailActivity.this.getWindow().setAttributes(lp);
            }
        });
        /**
         * 退出popupWindow时取消暗背景
    ...
    private void initWidget() {
        ...
        RlMenu.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ZongHengListActivity.class);
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(v.getContext(), ZongHengListActivity.class);
